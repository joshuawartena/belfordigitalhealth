...
def run_single_audit(
    ...
    *,
    ...
    try:
        ...
        checker = WebsiteSEOChecker(domain, url=audit.url)
    ...
    if not skip_pagespeed:
        try:
            ...
            checker = PageSpeedChecker(audit.url)
...
def load_batch_csv(csv_path: str) -> List[AuditResult]:
    ...
    with open(path, 'r', encoding='utf-8-sig') as f:
        ...
        for row_num, row in enumerate(reader, start=2):
            ...
            audit_url = raw_domain if re.match(r'^https?://', raw_domain) else f'https://{raw_domain}'
